									...
									<div class="container-fluid">
										...
										<div class="form-group">
											<div class="col-xs-12">
												...
												<input type="text" name="underpinorgname"
													   value="${project.underpinorgname}" class="col-xs-4">
											</div>
										</div>
										...
										<div class="form-group">
											<div class="col-xs-12">
												...
												<option value="0"
														<c:if test="${project.issureness == 0}">selected="selected"</c:if>>
													是
												</option>
												<option value="1"
														<c:if test="${project.issureness == 1}">selected="selected"</c:if>>
													否
												</option>
								...
								<div id="financingDiv">
									...
									<div class="col-xs-12">
										...
										<div class="form-group">
											...
											<div class="col-xs-4">
												<input type="text" class="col-xs-6" onkeyup="clearNoNum(this)"
													   name="rate" value="${project.rate}">
										...
										<div class="form-group">
											...
											<div class="col-xs-4">
												<div class="col-xs-6">
													<c:forEach var="inteProType" items="${inteProTypes}">
														<div class="col-xs-4">
															<input type="checkbox" id="check${inteProType.dcode}"
																   name="inteprotype" onblur="zscq()"
											...
											<div class="col-xs-4">
												<input type="text" class="col-xs-6" onkeyup="clearNoNum(this)"
													   name="hasloanamt" value="${project.hasloanamt}">
										...
										<div class="form-group">
											...
											<div class="col-xs-4">
												<input type="text" class="col-xs-6" autocomplete="off"
													   onkeyup="clearNoNum(this)" datatype="*" name="totalLiability"
													   value="${project.totalLiability}">
												<label class="col-xs-2 text-center control-label">元</label>
												<label class="Validform_checktip" style="color: red;"></label>
											</div>
										...
										<div class="form-group">
											...
											<div class="col-xs-4">
												<input type="text" class="col-xs-6" id="startDate"
													   name="newToBeListedFinancingTime"
...
<script type="text/javascript"
		src="${appCtx}/static/busi/project/project_mod.js"></script>
<script type="text/javascript"
