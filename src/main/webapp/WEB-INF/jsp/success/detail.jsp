...
<head>
	...
	<meta charset="utf-8" />
	<title>长春市科技金融服务平台 - 成功案例详情</title>
...
<div class="container" style="padding-top: 102px;">
	...
	<div class="row" style="position: absolute;">
		<img src="${appCtx}/static/images/yzz.png" style="width: 200px; height: 200px; margin-left: 476%; margin-top: -13%;">
	</div>
	...
	<div class="row" style="margin-top: 50px; text-align: center;">
		...
		<script src="${appCtx}/static/busi/success/detail.js"></script>
	</body>
</html>
