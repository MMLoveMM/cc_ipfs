...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>长春市科技金融服务平台 - 填写企业信息</title>
	...
	<body>
		...
		<div class="container" style="margin-top: 15px;">
			<div class="row">
				<label style="color: #4A4A4A;">当前位置: 首页 > 我要融资 > 填写企业 </label>
			</div>
		</div>
							...
							<div class="form-group">
								...
								<div class="col-xs-4">
									<div class="col-xs-2 text-center">
										<input type="radio" id="whetherListed" name="enterpriseInfo.whetherListed" value="是" title="是"> 是
									</div>
									<div class="col-xs-2 text-center">
										<input type="radio" id="whetherListed2" name="enterpriseInfo.whetherListed" value="否" title="否"> 否
									</div>
								</div>
							</div>
		...
		<script src="${appCtx}/static/busi/user_jsp/enter/enterprise_add.js"></script>
	</body>
</html>
